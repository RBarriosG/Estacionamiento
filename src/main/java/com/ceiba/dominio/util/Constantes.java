...
public final class Constantes {
	...
	public static final String OTRO_TIPO_VEHICULO = "OTRO TIPO DE VEHICULO";
	...
	public static final String LETRA_INICIAL_PLACA_A = "A";
	public static final String NO_PUEDE_INGRESAR_PORQUE_NO_ESTA_EN_UN_DIA_HABIL = "No puede ingresar porque no esta en un dia habil";
